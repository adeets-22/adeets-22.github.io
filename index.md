...
currently, im heading up strategy at [Celestia](https://celestia.org/), the first modular blockchain network. in my free time, i also scout for [Bain Cap Crypto](https://twitter.com/BainCapCrypto). in the past, i've held product roles at [ConsenSys](https://consensys.net/), [The Graph](https://thegraph.com/en/), and in fintech. 
